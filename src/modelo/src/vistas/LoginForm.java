...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnIngresar, javax.swing.GroupLayout.PREFERRED_SIZE, 31, Short.MAX_VALUE)
                .addContainerGap())
        );

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/pngocean.com (1).png"))); // NOI18N
    ...
    public void validar2 (){
        ...
        String dni = txtPass.getText();
        String Nombres = txtUser.getText();
        if (txtUser.getText().equals("") || txtPass.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "Debe Ingresar Datos En las cajas Texto");
            txtUser.requestFocus();
        } else {
            ec = clienteDAO.ValidarCliente(dni, Nombres);
            if (ec.getNom() != null && ec.getDni() != null) {
